...
$(document).ready(function() {
    $("div.contact-info:first-child").addClass(" wow animate__backInLeft")
    $("div.contact-info:last-child").addClass(" wow animate__backInRight")
    $("div.info-product > div.product, div.feedback-content, div.foot-contacts > div").addClass(" wow animate__backInUp")
    wow = new WOW({
